...
var instrucciones = ["Mira la imagen del rompecabezas que vas a formar.",
                     "Con las flechas del teclado move las piezas según tu necesidad.", 
                     "Hace esto hasta que completes a nuestro amigo."];
...
function intercambiarPosicionesGrilla(filaPos1, columnaPos1, filaPos2, columnaPos2) {
    //COMPLETAR
    let grillaAuxiliar = grilla [filaPos1][columnaPos1];
